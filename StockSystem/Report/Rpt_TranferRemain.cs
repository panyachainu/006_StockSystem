...
{
    public partial class Rpt_TranferRemain : DevExpress.XtraReports.UI.XtraReport
    {
        public Rpt_TranferRemain()
        {
            InitializeComponent();
        ...
        private void Rpt_Tranfer_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            lbl_UserPrint.Text = "ผู้พิมพ์ : " + Utility._UserDB;
            dtp_DateCurrent.Text = DateTime.Now.Date.ToLongDateString();
