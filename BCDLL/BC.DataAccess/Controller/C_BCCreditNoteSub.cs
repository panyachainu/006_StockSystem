...
{
    public class C_BCCreditNoteSub : I_BCCreditNoteSub
    {
        ...
        public BCCreditNoteSub GetFind(params object[] Keys)
        {
            return db.BCCreditNoteSub.Find(Keys);
        }
        ...
        public IEnumerable<BCCreditNoteSub> LoadAll(object para1, object para2, object para3, object para4, object para5)
        {
