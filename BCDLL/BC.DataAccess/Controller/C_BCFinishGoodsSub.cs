...
{
    public class C_BCFinishGoodsSub : I_BCFinishGoodsSub
    {
        ...
        public void Insert(BCFinishGoodsSub Items)
        {
            db.BCFinishGoodsSub.Add(Items);
        }

        public void Update(BCFinishGoodsSub Items)
        {
            throw new NotImplementedException();
        }

        public void Delete(BCFinishGoodsSub Items)
        {
            db.BCFinishGoodsSub.Remove(Items);
        }

        public BCFinishGoodsSub GetFind(params object[] Keys)
        {
            return db.BCFinishGoodsSub.Find(Keys);
        }
        ...
        public IEnumerable<BCFinishGoodsSub> LoadAll(object para1, object para2, object para3, object para4, object para5)
        {
