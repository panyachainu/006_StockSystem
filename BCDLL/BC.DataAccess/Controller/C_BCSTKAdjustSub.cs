...
{
    public class C_BCSTKAdjustSub : I_BCSTKAdjustSub
    {
        ...
        public void Insert(BCSTKAdjustSub Items)
        {
            db.BCSTKAdjustSub.Add(Items);
        }

        public void Update(BCSTKAdjustSub Items)
        {
            throw new NotImplementedException();
        }

        public void Delete(BCSTKAdjustSub Items)
        {
            db.BCSTKAdjustSub.Remove(Items);
        }

        public BCSTKAdjustSub GetFind(params object[] Keys)
        {
            return db.BCSTKAdjustSub.Find(Keys);
        }
        ...
        public IEnumerable<BCSTKAdjustSub> LoadAll(object para1, object para2, object para3, object para4, object para5)
        {
